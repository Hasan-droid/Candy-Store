...
export default function ShortDesc() {
  return (
    <div className="flex flex-col xl:col-span-4 xl:order-1 order-2 border-2 rounded-2xl border-2xl border-slate-400 bg-white p-5">
      ...
      <div className="font-poppins font-semibold text-xs text-custom-red-2 mb-4">
        ...
        <p>
          It&39;s the season for tying the knot and our wedding collection of
